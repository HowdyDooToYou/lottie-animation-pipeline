...
export async function handleMcpRequest(
  ...
  try {
    ...
    if (name === 'create_motion') {
      ...
      const requestInput: MotionProofRequestInput = {
        ...
        theme: args.theme === undefined ? undefined : MotionProofThemeSchema.parse(args.theme),
      };
    ...
    return toolFailure(id, `Unknown MotionProof tool: ${name}`);
  } catch (error) {
