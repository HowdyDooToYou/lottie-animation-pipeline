import type { SolidddRequest } from './contracts.ts';

export function buildProviderPrompt(request: SolidddRequest): string {
  return [
    'You are generating one production Lottie/Bodymovin animation for Soliddd.',
